      ...
      <table width="100%" height="100%">
        <tr>
          <td width="250px" style="padding: 10px" id="mainMenu">
            ...
            <li class="active"><a href="?module=main&page=char_repair">Исправление ошибок</a></li>
          ...
          <td style="padding: 10px">
            <center>
            <h2 style="margin-bottom: 20px; font-size: 24px; font-family: Arial">Исправить ошибки у персонажа:</h2>

            <p>Выберите персонажа:</p>
            [(var)heroesTable]
            <p>Эта функция телепортирует персонажа в таверну, будьте осторожны!</p>
            <p class="submit"><input type="submit" name="commit" value="Исправить"></p>
            </center>
          </td>
        </tr>
      </table>
