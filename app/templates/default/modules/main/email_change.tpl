      ...
      <table width="100%" height="100%">
        <tr>
          <td width="250px" style="padding: 10px" id="mainMenu">
            ...
            <li class="active"><a href="?module=main&page=email_change">Смена E-Mail</a></li>
          ...
          <td style="padding: 10px">
            <center>
            <h2 style="margin-bottom: 20px; font-size: 24px; font-family: Arial">Смена E-Mail:</h2>
              <p><input type="email" name="password" value="" placeholder="Новый E-Mail"></p>
              <p class="submit"><input type="submit" name="commit" value="Сменить E-Mail"></p>
            </center>
          </td>
        </tr>
      </table>
