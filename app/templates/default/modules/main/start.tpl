      ...
      <table width="100%" height="100%">
        <tr>
          <td width="250px" style="padding: 10px" id="mainMenu">
            ...
            <li class="active"><a href="?module=main&page=start">Информация об аккаунте</a></li>
          ...
          <td style="padding: 10px">
            <center>
            <h2 style="margin-bottom: 20px; font-size: 24px; font-family: Arial">Информация об аккаунте:</h2>
            <ul>
              <li>Количество персонажей на аккаунте: [(var)charactersCount]</li>
              <li>Последний вход в игровой мир: [(var)lastLogin]</li>
              <li>Текущий IP: [(server)REMOTE_ADDR]</li>
              <li>E-Mail: [(var)obfuscatedEmail]</li>
            </ul>
            </center>
          </td>
        </tr>
