      ...
      <table width="100%" height="100%">
        <tr>
          <td width="250px" style="padding: 10px" id="mainMenu">
            ...
            <li class="active"><a href="?module=main&page=race_change">Смена расы</a></li>
          ...
          <td style="padding: 10px">
            <center>
            <h2 style="margin-bottom: 20px; font-size: 24px; font-family: Arial">Сменить расу персонажу:</h2>
            <p>Выберите персонажа:</p>
            [(var)heroesTable]
            <p>Стоимость услуги составляет: [(var)raceChange_cost] монет</p>
