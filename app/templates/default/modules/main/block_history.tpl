      ...
      <table width="100%" height="100%">
        <tr>
          <td width="250px" style="padding: 10px" id="mainMenu">
            ...
            <li class="active"><a href="block_history">История блокировок</a></li>
          ...
          <td style="padding: 10px">
            <center>
            <h2 style="margin-bottom: 20px; font-size: 24px; font-family: Arial">История блокировок:</h2>
            <table id="main-table" style="text-align:center; margin-top:10px">
                <thead>
                  <tr>
                      <th scope="col">Тип блокировки</th>
                        <th scope="col">Причина блокировки</th>
                        <th scope="col">Кто заблокировал</th>
                        <th scope="col">Время блокировки</th>
                        <th scope="col">Время разблокировки</th>
                    </tr>
                </thead>
                <tbody>
                  <tr>
                      <td>Временный</td>
                        <td>Использование читов на сервере</td>
                        <td>dekamaru</td>
                        <td>13:03 13.03.2013</td>
                        <td>14:03 13.03.2013</td>
                    </tr>
                    <tr>
                      <td>Навсегда</td>
                        <td>Оскорбление администрации</td>
                        <td>dekamaru</td>
                        <td>15:03 13.03.2013</td>
                        <td>--</td>
                    </tr>
                </tbody>
            </table>
