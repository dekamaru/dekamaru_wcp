      ...
      <table width="100%" height="100%">
        <tr>
          <td width="250px" style="padding: 10px" id="mainMenu">
            ...
            <li class="active"><a href="?module=main&page=pass_change">Смена пароля</a></li>
          ...
          <td style="padding: 10px">
            <center>
              ...
              [(var)success]
              <form method="POST">
            <h2 style="margin-bottom: 20px; font-size: 24px; font-family: Arial">Смена пароля:</h2>
              <p><input type="password" name="old_pass" value="" placeholder="Старый пароль"></p>
              <p><input type="password" name="new_pass" value="" placeholder="Новый пароль"></p>
              <p><input type="password" name="new_pass_repeat" value="" placeholder="Подтвердите новый пароль"></p>
              <p class="submit"><input type="submit" name="commit" value="Сменить пароль"></p>
            </form>
            </center>
          </td>
        </tr>
