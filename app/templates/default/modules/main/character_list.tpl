      ...
      <table width="100%" height="100%">
        <tr>
          <td width="250px" style="padding: 10px" id="mainMenu">
            ...
            <li class="active"><a href="?module=main&page=character_list">Список персонажей</a></li>
          ...
          <td style="padding: 10px">
            <center>
            <h2 style="margin-bottom: 20px; font-size: 24px; font-family: Arial">Список персонажей:</h2>
           [(var)heroesTable]
            </center>
          </td>
        </tr>
